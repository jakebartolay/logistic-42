...
<html
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-2"><span class="text-muted fw-light">LOGISTICS /</span> Order List</h4>
                    ...
                    <div class="row gy-4 gy-sm-1">
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h4 class="mb-2" id="pending-count">{{ $pendingCount }}</h4>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h4 class="mb-2" id="completed-count">{{ $completedCount }}</h4>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            <h4 class="mb-2" id="refunded-count">{{ $refundedCount }}</h4>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                          <div>
                            <h4 class="mb-2" id="failed-count">{{ $failedCount }}</h4>
                        ...
                        <tbody id="order-table-body">
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <!--<td><button class="action_button"><strong>Ship Product</strong></button></td>-->
                                    <!-- Button to open the modal -->
                                  <td>
                                  <button class="action_button" onclick="markProductShipped({{ $order->order_id }})">
    <strong>Move to Outbound</strong>
</button>
                                  </td>
                    ...
                    @if ($orders->previousPageUrl())
                        <a href="{{ $orders->previousPageUrl() }}" id="prev-page">&lt; &nbsp;&nbsp;</a>
                    @endif
                    
                    <!-- Current page number -->
                    <span id="current-page">{{ $orders->currentPage() }}</span>
                    
                    <!-- Next button -->
                    @if ($orders->nextPageUrl())
                        <a href="{{ $orders->nextPageUrl() }}" id="next-page">&nbsp;&nbsp; &gt;</a>
                    @endif
                </div></center>
    ...
    function markProductShipped(orderId) {
        
        if (confirm('Proceed to Making an Invoice?')) {

            axios.post('{{ route("markProductShipped") }}', {
                orderId: orderId,
                _token: '{{ csrf_token() }}'
            })
